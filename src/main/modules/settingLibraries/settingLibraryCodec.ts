import {
  ...
  settingLibraryDynamicModeSchema,
  ...
  settingLibraryTriggerModeSchema,
...
export function readEntry(payloadJson: string): SettingLibraryEntry {
  ...
  return settingLibraryEntrySchema.parse({
    ...
    dynamicMode: settingLibraryDynamicModeSchema.safeParse(value.dynamic_mode).data ?? 'standard',
    ...
    triggerMode: settingLibraryTriggerModeSchema.safeParse(value.trigger_mode).data ?? null,
