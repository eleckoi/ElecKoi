...
CREATE TABLE IF NOT EXISTS `regex_enablement_versions` (`id` TEXT NOT NULL, `name` TEXT NOT NULL, `sortIndex` INTEGER NOT NULL, `globalEnabledIdsJson` TEXT NOT NULL, `characterEnabledIdsJson` TEXT NOT NULL, `agentPresetEnabledIdsJson` TEXT NOT NULL DEFAULT '[]', PRIMARY KEY(`id`));
